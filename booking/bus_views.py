...
def bus_whychoose_form(request):
    if request.method=="POST":
        ...
        k=bus_whychoose(title=title, content=content, image1=image1, image2=image2,image3=image3,image4=image4,image5=image5)
        k.save()
        return redirect("/whychoose_faq_op")   
...
def bus_whychoose_delete(request,id):
        ...
        k2.delete()
        return redirect("/whychoose_faq_op")
        return render(request,"bus_templates/whychoose_faq_del.html")
...
def bus_whychoose_faq_op(request):
    if request.method=="GET":
        k2=bus_whychoose.objects.all()
        k1=bus_faq.objects.all()
    return render(request,"bus_templates/whychoose_faq_del.html",{'k2': k2, 'k1':k1})
...
def bus_main13(request):
    if request.method=="GET":
        ...
        res12=ad.json()
        return render(request,"bus_templates/trendcard12.html",{'res12':res12})
...
def bus_main14(request):
    if request.method=="GET":
        ...
        res13=ad.json()
        return render(request,"bus_templates/trendcard13.html",{'res13':res13})
...
def bus_main15(request):
    if request.method=="GET":
        ...
        res15=ad.json()
        return render(request,"bus_templates/trendcard14.html",{'res15':res15})
...
def bus_main7(request):
    if request.method=="GET":
        ...
        res7=ad.json()
        return render(request,"bus_templates/trendcard15.html",{'res7':res7})
