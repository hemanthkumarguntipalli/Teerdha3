...
class faq_update(generics.RetrieveUpdateDestroyAPIView):
    queryset=faqs.objects.all()
    serializer_class=flightfaqs_serialization    
...
class choose_us(generics.ListCreateAPIView):
    queryset=choosing_content.objects.all()
    serializer_class=content_serialization
 
class whychooseus(generics.RetrieveUpdateDestroyAPIView):
    queryset=choosing_content.objects.all()
    serializer_class=content_serialization    
